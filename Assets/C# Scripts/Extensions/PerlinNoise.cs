...
public static class PerlinNoise
{
    ...
    // Helper function to fade values (used in Perlin interpolation)
    ...
    public static float Perlin(float x, float y)
    {
        ...
        // Hash coordinates of the 4 cube corners using the expanded permutation table
        int aa = perm[X + perm[Y]] % 12;
        int ab = perm[X + perm[Y + 1]] % 12;
        int ba = perm[X + 1 + perm[Y]] % 12;
        int bb = perm[X + 1 + perm[Y + 1]] % 12;
        ...
        return (res + 1) / 2; // Normalize the result to [0, 1]
    }
}
